...
import com.github.xjs.sbdemo.enums.BaseEnum;
import com.github.xjs.sbdemo.enums.EnumFactory;
...
//	    }
		...
		List<Class<BaseEnum>> enumClasses = EnumFactory.getAllEnumClass();
	    for(Class<?> enumClass : enumClasses ) {
	    	 configuration.getTypeHandlerRegistry().register(enumClass, EnumHandler.class);
	    }
